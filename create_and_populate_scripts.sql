create database order_entry_system;
use order_entry_system;
/* This database is used by distributor of toys
Tables are used to perform tasks such as 
Manage vendors, 
Manage product catlogs,
